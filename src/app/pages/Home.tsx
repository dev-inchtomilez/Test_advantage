...
{
  /*
  HOME MEGA HERO — CORRECTED DROP-IN REPLACEMENT

  Required imports at the top of Home.tsx:
  import { motion } from "motion/react";
  import { Link } from "react-router-dom";
  import { ArrowRight, Sparkles } from "lucide-react";
  import { ParticleGlobe } from "<keep-your-existing-particle-globe-path>";

  Replace only the previous HOME MEGA HERO section with this block.
*/
}

<section
  aria-labelledby="home-hero-title"
  className="adv-home-hero relative isolate min-h-[calc(100svh-72px)] w-full overflow-x-clip bg-[#080915]"
>
  <style>
    {`
      .adv-home-hero .adv-hero-slide {
        opacity: 0;
        transform: scale(1.065);
        animation: advHeroSlide 32s ease-in-out infinite;
        animation-fill-mode: both;
        will-change: opacity, transform;
      }

      .adv-home-hero .adv-hero-slide:nth-child(1) { animation-delay: 0s; }
      .adv-home-hero .adv-hero-slide:nth-child(2) { animation-delay: 8s; }
      .adv-home-hero .adv-hero-slide:nth-child(3) { animation-delay: 16s; }
      .adv-home-hero .adv-hero-slide:nth-child(4) { animation-delay: 24s; }

      @keyframes advHeroSlide {
        0% {
          opacity: 1;
          transform: scale(1.065);
        }
      ...
      @keyframes advHeroOrbit {
        from { transform: translate(-50%, -50%) rotate(0deg); }
        to { transform: translate(-50%, -50%) rotate(360deg); }
      }

      @keyframes advHeroOrbitReverse {
        from { transform: translate(-50%, -50%) rotate(360deg); }
        to { transform: translate(-50%, -50%) rotate(0deg); }
      }

      @keyframes advHeroFloat {
        0%, 100% { transform: translate3d(0, 0, 0); }
        50% { transform: translate3d(0, -7px, 0); }
      }

      @keyframes advHeroFloatReverse {
        0%, 100% { transform: translate3d(0, -3px, 0); }
        50% { transform: translate3d(0, 5px, 0); }
      }

      @keyframes advHeroPulse {
        0%, 100% { opacity: 0.48; box-shadow: 0 0 0 0 rgba(255, 179, 0, 0); }
        50% { opacity: 1; box-shadow: 0 0 0 5px rgba(255, 179, 0, 0.11); }
      }

      @keyframes advHeroAmbient {
        0%, 100% { opacity: 0.46; }
        50% { opacity: 0.82; }
      }

      .adv-home-hero .adv-orbit {
        animation: advHeroOrbit 54s linear infinite;
      }

      .adv-home-hero .adv-orbit-reverse {
        animation: advHeroOrbitReverse 70s linear infinite;
      }

      .adv-home-hero .adv-float {
        animation: advHeroFloat 6.5s ease-in-out infinite;
      }

      .adv-home-hero .adv-float-reverse {
        animation: advHeroFloatReverse 7.5s ease-in-out infinite;
      }

      .adv-home-hero .adv-pulse {
        animation: advHeroPulse 2.8s ease-in-out infinite;
      }

      .adv-home-hero .adv-ambient {
        animation: advHeroAmbient 9s ease-in-out infinite;
      }
      ...
      @media (prefers-reduced-motion: reduce) {
        ...
        .adv-home-hero .adv-hero-slide:first-child {
          opacity: 1;
        }
      }
    `}
  ...
  >
    <img
      ...
      fetchPriority="high"
      decoding="async"
      className="adv-hero-slide absolute inset-0 h-full w-full object-cover object-center"
    />
    <img
    ...
    <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,6,18,0.86)_0%,rgba(5,6,18,0.70)_38%,rgba(5,6,18,0.38)_68%,rgba(5,6,18,0.56)_100%)]" />
    <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,6,18,0.15)_0%,rgba(5,6,18,0.04)_43%,rgba(5,6,18,0.78)_100%)]" />

    <div className="adv-ambient absolute -left-52 top-[10%] h-[480px] w-[480px] rounded-full bg-[#0000aa]/20 blur-[150px]" />
    <div className="adv-ambient absolute -right-44 bottom-[-8%] h-[440px] w-[440px] rounded-full bg-[#ffb300]/15 blur-[140px]" />
  ...
  <motion.div
    aria-hidden="true"
    className="absolute left-0 top-0 z-30 h-[3px] bg-[linear-gradient(90deg,#0000aa_0%,#3346ff_52%,#ffb300_100%)]"
    initial={{ width: 0 }}
    animate={{ width: "100%" }}
    transition={{ duration: 1.15, ease: [0.22, 1, 0.36, 1] }}
  />

  <div className="relative z-10 flex min-h-[calc(100svh-72px)] w-full items-center py-7 sm:py-9 lg:py-10">
    <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 xl:px-10">
      <motion.div
        className="mb-4 hidden items-center justify-between border-b border-white/15 pb-3 lg:flex"
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.1 }}
      >
        <div className="flex items-center gap-3">
          <span className="text-[9px] font-bold uppercase tracking-[0.18em] text-[#ffb300]">
            AdvantEdge
          </span>
          <span className="h-3 w-px bg-white/20" />
          <span className="text-[9px] font-medium uppercase tracking-[0.16em] text-white/60">
            Strategy • Execution • Intelligence • Growth
          </span>
        </div>

        <div className="flex items-center gap-2">
          <span className="adv-pulse h-1.5 w-1.5 rounded-full bg-[#ffb300]" />
      ...
      <div className="grid items-stretch gap-4 lg:grid-cols-12 lg:gap-5">
        {/* Content panel */}
        <motion.div
          className="relative overflow-hidden rounded-[24px] border border-white/55 bg-white/[0.94] shadow-[0_30px_90px_rgba(0,0,0,0.28)] backdrop-blur-2xl lg:col-span-6"
          initial={{ opacity: 0, x: -38, y: 8 }}
          animate={{ opacity: 1, x: 0, y: 0 }}
          transition={{ duration: 0.78, ease: [0.22, 1, 0.36, 1] }}
        >
          <div className="absolute inset-x-0 top-0 h-[3px] bg-[linear-gradient(90deg,#0000aa_0%,#3346ff_55%,#ffb300_100%)]" />
          <div className="pointer-events-none absolute -right-24 -top-28 h-[300px] w-[300px] rounded-full bg-[#ffb300]/10 blur-[95px]" />
          <div className="pointer-events-none absolute -bottom-28 -left-28 h-[300px] w-[300px] rounded-full bg-[#0000aa]/[0.07] blur-[100px]" />
          ...
          <div className="relative z-10 p-5 sm:p-6 lg:p-7 xl:p-8">
            ...
            >
              <span className="inline-flex items-center rounded-full border border-[#ffb300]/55 bg-white/90 px-3 py-1.5 shadow-[0_8px_24px_rgba(255,179,0,0.12)] backdrop-blur-xl">
                <Sparkles className="mr-2 h-3.5 w-3.5 text-[#ffb300]" />
                <span className="text-[11px] font-bold tracking-wide text-[#000131] sm:text-xs">
            ...
            <motion.h1
              id="home-hero-title"
              className="max-w-[680px] text-[clamp(1.8rem,4.7vw,3.55rem)] font-bold leading-[1.04] tracking-[-0.04em] text-[#000131]"
            ...
            >
              ...
              <span className="relative inline-block whitespace-nowrap">
                <span className="relative z-10">Integrated Execution.</span>
                <motion.span
                  aria-hidden="true"
                  className="absolute bottom-[0.08em] left-0 z-0 h-[0.18em] rounded-full bg-[#ffb300]/35"
                  initial={{ width: 0 }}
                  animate={{ width: "100%" }}
            ...
            >
              <p className="text-sm font-semibold leading-snug text-[#000131] sm:text-[15px]">
                Growth is not accidental. It is engineered.
              </p>
              <p className="max-w-[620px] text-[13px] leading-[1.72] text-slate-600 sm:text-sm">
                We build revenue-driven marketing systems that connect strategy,
                execution, and AI - so every effort drives measurable growth.
              </p>
            </motion.div>
            ...
            >
              <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.985 }}>
                <Link
                  to="/contact"
                  className="group inline-flex min-h-12 w-full items-center justify-center rounded-xl bg-[linear-gradient(135deg,#000131_0%,#0000aa_72%,#3346ff_100%)] px-5 py-3 text-center text-[13px] font-bold text-white shadow-[0_14px_34px_rgba(0,0,170,0.24)] transition-shadow duration-300 hover:shadow-[0_18px_42px_rgba(0,0,170,0.34)] sm:w-auto sm:px-6 sm:text-sm"
                >
              ...
              <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.985 }}>
                <Link
                  to="/services"
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-xl border border-[#000131]/25 bg-white/75 px-5 py-3 text-[13px] font-bold text-[#000131] shadow-[0_10px_26px_rgba(0,1,49,0.06)] backdrop-blur-xl transition-all duration-300 hover:border-[#0000aa]/35 hover:bg-white hover:shadow-[0_14px_34px_rgba(0,1,49,0.10)] sm:w-auto sm:px-6 sm:text-sm"
                >
                  Explore Services
                </Link>
              </motion.div>
            ...
            <motion.div
              className="mt-5 overflow-hidden rounded-2xl border border-slate-200/80 bg-white/75 shadow-[0_12px_35px_rgba(0,1,49,0.055)]"
            ...
            >
              <div className="grid grid-cols-3 divide-x divide-slate-200/80">
                {[
                  ...
                  <motion.div
                    key={metric.label}
                    className="min-w-0 px-2.5 py-3.5 sm:px-4"
                    whileHover={{ backgroundColor: "rgba(248,250,252,0.96)" }}
                  >
                    <p className="truncate text-lg font-bold tracking-[-0.03em] text-[#000131] sm:text-xl">
                      {metric.value}
                    </p>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-x-2 gap-y-1.5 border-t border-slate-200/80 pt-4 text-[10px] font-semibold text-slate-500">
              <span>Strategy</span>
              ...
              <span>AI</span>
              <ArrowRight className="h-3 w-3 text-slate-300" />
              <span className="text-[#000131]">Measurable Growth</span>
            </div>
          </div>
        </motion.div>

        {/* Particle-globe command centre */}
        <motion.div
          className="relative min-h-[390px] overflow-hidden rounded-[24px] border border-white/25 bg-[#03051a]/60 shadow-[0_30px_90px_rgba(0,0,0,0.32)] backdrop-blur-xl sm:min-h-[470px] lg:col-span-6 lg:min-h-full"
          initial={{ opacity: 0, x: 38, y: 8 }}
          animate={{ opacity: 1, x: 0, y: 0 }}
          transition={{ duration: 0.78, ease: [0.22, 1, 0.36, 1], delay: 0.1 }}
        >
          <div className="absolute inset-x-0 top-0 z-30 h-[3px] bg-[linear-gradient(90deg,#0000aa_0%,#3346ff_55%,#ffb300_100%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_48%,rgba(0,0,170,0.22),transparent_46%)]" />

          <div className="absolute left-4 right-4 top-4 z-30 flex items-start justify-between gap-3 sm:left-5 sm:right-5 sm:top-5">
            <div>
              <p className="text-[8px] font-bold uppercase tracking-[0.16em] text-[#ffb300] sm:text-[9px]">
                Global Growth Infrastructure
              </p>
              <p className="mt-1 text-[10px] font-semibold text-white/70 sm:text-xs">
                Connected strategy. Intelligent execution.
              </p>
            </div>

            <div className="flex shrink-0 items-center gap-2 rounded-full border border-white/15 bg-black/25 px-2.5 py-1.5 backdrop-blur-xl sm:px-3">
              <span className="adv-pulse h-1.5 w-1.5 rounded-full bg-[#ffb300]" />
          ...
          <div
            aria-hidden="true"
            className="adv-ambient absolute left-1/2 top-1/2 h-[270px] w-[270px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(0,0,170,0.34)_0%,rgba(0,1,49,0.22)_48%,transparent_72%)] blur-[70px] sm:h-[340px] sm:w-[340px] sm:blur-[90px]"
          />

          <div
            aria-hidden="true"
            className="absolute left-1/2 top-1/2 h-[250px] w-[250px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/15 sm:h-[355px] sm:w-[355px]"
          />

          <div
            aria-hidden="true"
            className="adv-orbit absolute left-1/2 top-1/2 h-[278px] w-[278px] rounded-full border border-white/15 sm:h-[390px] sm:w-[390px]"
          >
            <span className="absolute left-1/2 top-[-4px] h-2 w-2 -translate-x-1/2 rounded-full bg-[#ffb300] shadow-[0_0_18px_#ffb300]" />
          </div>

          <div
            aria-hidden="true"
            className="adv-orbit-reverse absolute left-1/2 top-1/2 h-[205px] w-[300px] rounded-[50%] border border-white/10 sm:h-[300px] sm:w-[430px]"
          />

          <div
            aria-hidden="true"
            className="absolute left-[7%] right-[7%] top-1/2 h-px bg-gradient-to-r from-transparent via-white/15 to-transparent"
          />
          <div
            aria-hidden="true"
            className="absolute bottom-[10%] left-1/2 top-[10%] w-px bg-gradient-to-b from-transparent via-white/10 to-transparent"
          />

          {/* Exact existing ParticleGlobe configuration */}
          <div className="absolute inset-0 z-20 flex items-center justify-center overflow-hidden">
            <div className="origin-center scale-[0.52] sm:scale-[0.74] lg:scale-[0.80] xl:scale-[0.90]">
              <ParticleGlobe
                width={450}
                height={450}
                particleCount={1200}
          ...
          <div className="adv-float absolute right-3 top-[24%] z-30 hidden min-w-[155px] rounded-2xl border border-white/20 bg-black/25 px-3.5 py-3 shadow-xl backdrop-blur-xl sm:block lg:right-4">
          ...
          <div className="adv-float-reverse absolute bottom-[17%] left-3 z-30 hidden rounded-2xl border border-white/20 bg-black/25 px-3.5 py-3 shadow-xl backdrop-blur-xl md:block lg:left-4">
            <p className="text-[8px] font-bold uppercase tracking-[0.14em] text-white/45">
              Performance
            </p>
            <div className="mt-1 flex items-baseline gap-1">
              <span className="text-2xl font-black tracking-[-0.04em] text-[#ffb300]">
                4.1x
              </span>
          ...
          <div className="absolute bottom-4 left-4 right-4 z-30 flex items-center justify-between border-t border-white/15 pt-3">
      ...
      {/* Capability rail */}
      <motion.div
        className="mt-4 overflow-hidden rounded-2xl border border-white/20 bg-black/25 shadow-[0_20px_60px_rgba(0,0,0,0.20)] backdrop-blur-xl sm:mt-5"
        initial={{ opacity: 0, y: 18 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <motion.div
              key={item.number}
              className={`group relative min-w-0 px-4 py-4 sm:px-5 ${
                index < 3
                  ? "border-b border-white/[0.12] lg:border-b-0 lg:border-r"
                  : ""
              } ${index === 1 ? "sm:border-l sm:border-white/[0.12] lg:border-l-0" : ""}`}
              whileHover={{ backgroundColor: "rgba(255,255,255,0.07)" }}
              transition={{ duration: 0.25 }}
            >
              <div className="flex items-start gap-3">
                <span className="shrink-0 text-[9px] font-black tracking-[0.14em] text-[#ffb300]">
                  {item.number}
                </span>
                <div className="min-w-0">
                  <p className="text-xs font-bold text-white">{item.title}</p>
                  <p className="mt-1 text-[9px] leading-[1.55] text-white/55">
                    {item.text}
                  </p>
                </div>
              </div>
              <div className="absolute bottom-0 left-0 h-[2px] w-full origin-left scale-x-0 bg-[linear-gradient(90deg,#0000aa,#ffb300)] transition-transform duration-500 group-hover:scale-x-100" />
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      >
        {[0, 1, 2, 3].map((item) => (
          ...
          >
            <motion.span
              className="block h-full w-full origin-left bg-[linear-gradient(90deg,#0000aa,#ffb300)]"
              animate={{ scaleX: [0, 1, 1, 0], opacity: [0.25, 1, 1, 0.25] }}
              transition={{
                duration: 8,
                delay: item * 8,
                repeat: Infinity,
  ...
  <div
    aria-hidden="true"
    className="pointer-events-none absolute bottom-0 left-0 right-0 z-[2] h-20 bg-gradient-to-b from-transparent to-[#080915]/80"
  />
</section>;
...
{/* ============================================
    2. HOW WE WORK — GROWTH OPERATING SYSTEM
============================================ */}
<ModernSectionBackground
...
>
  ...
  >
    ...
    >
      ...
      {/* Left Blue Glow */}
      <div
        className="absolute -left-52 top-24 h-[520px] w-[520px] rounded-full opacity-[0.08] blur-[140px]"
        style={{ backgroundColor: colors.brand.secondary }}
      />

      {/* Right Yellow Glow */}
      <div
        className="absolute -right-48 bottom-4 h-[500px] w-[500px] rounded-full opacity-[0.10] blur-[140px]"
        style={{ backgroundColor: colors.brand.accent }}
      />

      {/* Central Soft Glow */}
      <div
        className="absolute left-1/2 top-1/2 h-[620px] w-[620px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-[0.035] blur-[150px]"
        style={{ backgroundColor: colors.brand.secondary }}
      />
    </div>
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div
              className="
                ...
                px-4
                py-2
                shadow-[0_8px_28px_rgba(0,1,49,0.06)]
                backdrop-blur-xl
              "
              style={{
                color: colors.brand.secondary,
            ...
            {/* Description */}
            <p className="mx-auto mt-5 max-w-3xl text-sm leading-[1.8] text-gray-600 sm:text-base">
              A structured approach designed for measurable outcomes - aligned
              to your goals, built for real growth.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.08}>
          <div
            className="
              ...
              px-5
              py-4
              shadow-[0_14px_42px_rgba(0,1,49,0.055)]
              backdrop-blur-xl
              sm:flex-row
              sm:items-center
              sm:justify-between
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: colors.brand.primary }}
                >
                  Strategy → Execution → Optimization → Scale
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <span
                ...
                style={{
                  backgroundColor: colors.brand.accent,
                  boxShadow: `0 0 14px ${colors.brand.accent}`,
                }}
              />
          ...
          const workSteps = [
            {
              ...
              icon: Search,
              intro: "We evaluate your current state across:",
              items: [
            ...
            },
            {
              ...
              icon: Target,
              intro: "We design a complete growth system:",
              groups: [
                {
                  title: "Strategic Marketing",
                  text: "Positioning, portfolio & pricing strategy",
                },
                {
                  title: "Integrated Marketing",
                  text: "Channel mix, campaign strategy, communication framework",
                },
                {
                  title: "AI Strategy",
                  text: "CRM integration, automation workflows, lead intelligence",
                },
              ],
              footer:
                "Includes execution roadmap with clear milestones.",
            },
            {
              number: "03",
              label: "Integrated Execution",
              icon: Layers,
              intro: "We move from planning to action:",
              items: [
            ...
            },
            {
              ...
              icon: BarChart3,
              intro: "We continuously improve performance:",
              items: [
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(
                    to bottom,
                    transparent,
                    ${colors.brand.secondary}30 8%,
                    ${colors.brand.secondary}30 92%,
                    transparent
                  )`,
                }}
              />
                        ...
                        >
                          <motion.div
                            ...
                            className="
                              ...
                              bg-white/72
                              p-5
                              shadow-[0_18px_55px_rgba(0,1,49,0.07)]
                              backdrop-blur-xl
                              transition-all
                              duration-300
                              hover:bg-white/92
                              hover:shadow-[0_25px_70px_rgba(0,1,49,0.13)]
                              sm:p-6
                            "
                          >
                            {/* Accent Top */}
                              ...
                              <div className="relative z-10 mt-4 grid gap-2.5 sm:grid-cols-2">
                                {step.items.map((item) => (
                                  ...
                                  >
                                    ...
                                    <span className="text-[11px] leading-[1.55] text-gray-600 sm:text-xs">
                                      {item}
                                    </span>
                                  </div>
                                ))}
                                  ...
                                  >
                                    <div className="flex items-start gap-3">
                                      ...
                                      <div>
                                        ...
                                        <p className="mt-0.5 text-[11px] leading-[1.6] text-gray-600 sm:text-xs">
                                          {group.text}
                                        </p>
                                      </div>
                                    </div>
                          ...
                          >
                            ...
                            <div
                              className="
                                ...
                                font-black
                                text-white
                                shadow-[0_10px_30px_rgba(0,1,49,0.2)]
                              "
                              style={{
                                background: gradients.primary,
                              }}
                          ...
                          className={`
                            ...
                            ${
                              reverse
                                ...
                                : "lg:col-start-3 lg:row-start-1 lg:justify-start"
                            }
                          `}
                        >
                          <div
                          ...
                          >
                            ...
                            >
                              {index === 0 &&
                                "Know exactly where growth is being blocked."}

                              {index === 1 &&
                                "Build the system before increasing activity."}

                              {index === 2 &&
                                "Turn strategy into coordinated execution."}

                              {index === 3 &&
                                "Invest more where performance is proven."}
                            </p>
        ...
        <ScrollReveal delay={0.15}>
          <div
            className="
              ...
              px-5
              py-6
              shadow-[0_24px_70px_rgba(0,1,49,0.22)]
              sm:px-7
              lg:px-8
            "
          >
            ...
            >
              ...
              <div className="max-w-xl">
                ...
                <h3
                  ...
                  "
                >
                  Every stage feeds intelligence into the next.
                </h3>

                <p className="mt-2 max-w-lg text-xs leading-[1.7] text-white/55 sm:text-sm">
                  Strategy informs execution. Execution creates data. Data
                  improves decisions. Better decisions create more predictable
                  growth.
                </p>
              </div>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="mt-2 text-[9px] font-bold uppercase tracking-[0.14em] text-white/35">
                        {item.number}
                      </p>

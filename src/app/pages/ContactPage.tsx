/**
 * ============================================
 * ADVANTEDGE BIG FOOTER — FINAL PRODUCTION VERSION
 * ============================================
 *
 * Contact details:
 * - General Enquiries:
 ...
 *
 * No placeholder phone/address included.
 * ============================================
 */
...
const trustBadges = [
  ...
  },
  {
    ...
    text: '94% Client Satisfaction',
  },
  {
    icon: <Heart className="h-4 w-4" />,
    text: '87% Client Retention',
  },
];
...
export function BigFooter() {
  ...
  const handleNewsletterSubmit = async (
    ...
    try {
      ...
      if (result.success) {
        toast.success(
          "Thank you for subscribing! We'll send you our latest insights."
        );
                ...
                <div className="flex items-start gap-4 sm:gap-5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-[1.7] text-gray-600">
                      Partner with AdvantEdge to build marketing systems
                      that deliver clarity, consistency, and measurable
                      results.
                    </p>
            ...
            <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
              ...
              >
                ...
                <p className="mt-5 max-w-md text-[13px] leading-[1.8] text-white/[0.62]">
                  Strategic marketing consultancy that brings clarity,
                  structure, and accountability to marketing initiatives.
                  We serve organizations that value substance over hype.
                </p>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <a
                    ...
                    aria-label="Email AdvantEdge general enquiries"
                  >

                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-white/[0.06] transition-all duration-300 group-hover:border-white/20 group-hover:bg-white/[0.10]">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="mt-0.5 block break-all text-[12px] font-medium text-white/[0.72] transition-colors group-hover:text-white">
                  ...
                  {/* Dwight Jordan */}
                  <a
                    href={`mailto:${contactConfig.email.dwight}`}
                    className="group flex items-center gap-3 text-white/[0.65] transition-colors hover:text-white"
                    aria-label="Email Dwight Jordan"
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-xl text-[11px] leading-[1.65] text-white/[0.48]">
                    Subscribe to receive strategic marketing insights,
                    industry trends, and best practices delivered to your
                    inbox.
                  </p>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              {trustBadges.map((badge, index) => (
                ...
                >
                  ...
                  <span className="text-[11px] font-semibold text-white/[0.65]">
                    {badge.text}
                  </span>
          ...
          <div className="border-t border-white/10 py-5">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <p className="text-[10px] leading-relaxed text-white/[0.35]">
                © {currentYear} AdvantEdge. All rights reserved.
